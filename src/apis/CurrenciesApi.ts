...
export interface GetCurrencyBalancesRequest {
    currencyId: string;
    address?: string;
    walletId?: string;
}
...
export class CurrenciesApi extends runtime.BaseAPI {
     ...
     */
    async getCurrencyBalancesRaw(requestParameters: GetCurrencyBalancesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<number>> {
        if (requestParameters.currencyId === null || requestParameters.currencyId === undefined) {
            throw new runtime.RequiredError('currencyId','Required parameter requestParameters.currencyId was null or undefined when calling getCurrencyBalances.');
        }
     ...
     * Get currency balance
     */
    async getCurrencyBalances(requestParameters: GetCurrencyBalancesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<number> {
        const response = await this.getCurrencyBalancesRaw(requestParameters, initOverrides);
        return await response.value();
    }
