...
export class GamesApi extends runtime.BaseAPI {
     ...
     * Update game
     */
    async updateGameRaw(requestParameters: UpdateGameOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GameModel>> {
        if (requestParameters.gameId === null || requestParameters.gameId === undefined) {
     ...
     * Update game
     */
    async updateGame(requestParameters: UpdateGameOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GameModel> {
