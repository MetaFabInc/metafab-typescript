...
export class ItemsApi extends runtime.BaseAPI {
     ...
     */
    async getCollectionApprovalRaw(requestParameters: GetCollectionApprovalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<number>> {
        if (requestParameters.collectionId === null || requestParameters.collectionId === undefined) {
     ...
     * Get collection approval
     */
    async getCollectionApproval(requestParameters: GetCollectionApprovalRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<number> {
     ...
     * Get collection item
     */
    async getCollectionItemRaw(requestParameters: GetCollectionItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<object>>> {
        if (requestParameters.collectionId === null || requestParameters.collectionId === undefined) {
     ...
     * Get collection item
     */
    async getCollectionItem(requestParameters: GetCollectionItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<object>> {
