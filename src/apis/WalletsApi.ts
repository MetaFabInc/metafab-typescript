...
import {
    CreateWalletSignatureRequestFromJSON,
    CreateWalletSignatureRequestToJSON,
...
export interface CreateWalletSignatureOperationRequest {
    walletId: string;
...
export class WalletsApi extends runtime.BaseAPI {
     ...
     */
    async createWalletSignatureRaw(requestParameters: CreateWalletSignatureOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>> {
        if (requestParameters.walletId === null || requestParameters.walletId === undefined) {
            throw new runtime.RequiredError('walletId','Required parameter requestParameters.walletId was null or undefined when calling createWalletSignature.');
        }

        if (requestParameters.xWalletDecryptKey === null || requestParameters.xWalletDecryptKey === undefined) {
            throw new runtime.RequiredError('xWalletDecryptKey','Required parameter requestParameters.xWalletDecryptKey was null or undefined when calling createWalletSignature.');
        }

        if (requestParameters.createWalletSignatureRequest === null || requestParameters.createWalletSignatureRequest === undefined) {
            throw new runtime.RequiredError('createWalletSignatureRequest','Required parameter requestParameters.createWalletSignatureRequest was null or undefined when calling createWalletSignature.');
        }
        ...
        const response = await this.request({
            path: `/v1/wallets/{walletId}/signatures`.replace(`{${"walletId"}}`, encodeURIComponent(String(requestParameters.walletId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: CreateWalletSignatureRequestToJSON(requestParameters.createWalletSignatureRequest),
        }, initOverrides);
     ...
     * Create wallet signature
     */
    async createWalletSignature(requestParameters: CreateWalletSignatureOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string> {
        const response = await this.createWalletSignatureRaw(requestParameters, initOverrides);
