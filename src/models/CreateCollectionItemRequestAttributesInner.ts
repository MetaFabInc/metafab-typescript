...
import type { CreateCollectionItemRequestAttributesInnerValue } from './CreateCollectionItemRequestAttributesInnerValue';
import {
    CreateCollectionItemRequestAttributesInnerValueFromJSON,
    CreateCollectionItemRequestAttributesInnerValueFromJSONTyped,
    CreateCollectionItemRequestAttributesInnerValueToJSON,
} from './CreateCollectionItemRequestAttributesInnerValue';
...
export function CreateCollectionItemRequestAttributesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateCollectionItemRequestAttributesInner {
    ...
    return {
        ...
        'value': CreateCollectionItemRequestAttributesInnerValueFromJSON(json['value']),
    };
}
...
export function CreateCollectionItemRequestAttributesInnerToJSON(value?: CreateCollectionItemRequestAttributesInner | null): any {
    ...
    return {
        ...
        'value': CreateCollectionItemRequestAttributesInnerValueToJSON(value.value),
    };
}
