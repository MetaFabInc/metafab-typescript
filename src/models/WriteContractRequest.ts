...
import type { WriteContractRequestArgsInner } from './WriteContractRequestArgsInner';
import {
    WriteContractRequestArgsInnerFromJSON,
    WriteContractRequestArgsInnerFromJSONTyped,
    WriteContractRequestArgsInnerToJSON,
} from './WriteContractRequestArgsInner';
...
export interface WriteContractRequest {
     ...
     * @type {Array<WriteContractRequestArgsInner>}
     * @memberof WriteContractRequest
     */
    args?: Array<WriteContractRequestArgsInner>;
}
...
export function WriteContractRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): WriteContractRequest {
    ...
    return {
        ...
        'func': json['func'],
        'args': !exists(json, 'args') ? undefined : ((json['args'] as Array<any>).map(WriteContractRequestArgsInnerFromJSON)),
    };
}
...
export function WriteContractRequestToJSON(value?: WriteContractRequest | null): any {
    ...
    return {
        ...
        'func': value.func,
        'args': value.args === undefined ? undefined : ((value.args as Array<any>).map(WriteContractRequestArgsInnerToJSON)),
    };
}
